...
[_SYMBOL] = LAYOUT(
  ...
  _______, KC_HOME, KC_END , KC_LBRC, KC_RBRC, KC_B   , _______,  _______, KC_GRV , KC_MINS, KC_PGUP, _______, _______, _______,
...
[_FKEYS] = LAYOUT(
  ...
  _______, _______, _______, KC_VOLD, KC_VOLU, KC_MPLY,  _______,  _______,  _______, _______, _______, _______, _______, QK_BOOT,
                            _______, _______, _______,  _______,    _______,  _______, _______, _______
)
};
