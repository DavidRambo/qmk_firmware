...
#define CTLPGUP LCTL(KC_PGUP)   // back one tab on Windows
#define CTLPGDN LCTL(KC_PGDN)   // forward one tab on Windows
...
[_COLEMAK] = LAYOUT_preonic_grid( \
  ...
  HMRSP  , KC_RCTL, KC_LGUI, KC_LCTL, KC_LALT, BS_GUI,  KC_SPC,  MO(3),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
...
[_SYMBOL] = LAYOUT_preonic_grid(
  ...
  _______, KC_HOME, KC_END , KC_MNXT, KC_MPLY, KC_BRMD, KC_BRMU, KC_MINS, KC_PGUP, _______, _______, _______, \
